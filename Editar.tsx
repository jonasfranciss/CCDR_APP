...
export default function Editar({ route, navigation }: any) {
  ...
  const renderHeader = () => (
    <View style={styles.card}>
      <Text style={styles.sectionTitle}>Editar Dados Gerais</Text>
      ...
      <Text style={styles.label}>Nome Promotor</Text><TextInput style={[styles.input, webStyle]} value={nomePromotor} onChangeText={setNomePromotor} />
      
      <Text style={styles.sectionTitle}>Editar Verificações</Text>
      <Text style={styles.label}>Controlo Visual</Text><TextInput style={[styles.input, styles.textArea, webStyle]} multiline value={controloVisual} onChangeText={setControloVisual} />
      <Text style={styles.label}>Outras Verificações</Text><TextInput style={[styles.input, styles.textArea, webStyle]} multiline value={outrasVerificacoes} onChangeText={setOutrasVerificacoes} />
      
      <Text style={styles.sectionTitle}>Organizar Fotos</Text>
    </View>
  );
